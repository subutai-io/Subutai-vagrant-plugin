...
Gem::Specification.new do |spec|
  ...
  spec.files         = ["lib/subutai_cli.rb", "lib/subutai_cli/config.rb", "lib/subutai_cli/command.rb", "lib/subutai_cli/version.rb", "lib/subutai_cli/plugin.rb", "lib/vagrant_init.rb"]
